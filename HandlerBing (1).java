...
public class HandlerBing extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    btLambda.setOnAction(e -> separateMethod(e) );
  ...
  private void separateMethod(ActionEvent ae) {
      System.out.println(ae.getEventType());
      Button b = (Button) ae.getSource();
      System.out.println(b.getText());

      numClicks++;
      text.setText(b.getText()+" clicked "+numClicks);
  }
